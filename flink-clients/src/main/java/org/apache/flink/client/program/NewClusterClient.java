...
//	 *
//	 * @param jobId for which to request the {@link JobExecutionResult}
//	 * @return Future which is completed with the {@link JobExecutionResult}
//	 */
//	CompletableFuture<JobExecutionResult> requestJobResult(@Nonnull JobID jobId);
//}
